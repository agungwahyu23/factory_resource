...
<script type="text/javascript">
	...
	$(document).on("click",".choose_material",function(){
		...
		detail_material_html = `
            <tr id="list_detail_material` + count_list_material + `">
                ...
                <td>
                    <input type="text" class="form-control " name="return_amount[]" value="`+material_price+`" type="text" id="return_amount` + count_list_material + `">
                </td>
                <td>
                    <input type="text" class="form-control " name="information[]" type="text" id="information` + count_list_material + `">
                </td>
	...
	$(document).ready(function() {
		...
		table_modal = $('#modal_item').DataTable({
				...
				"ajax": {
					"url": "<?php echo site_url('Returns/ajax_list_modal')?>",
					"type": "POST"
...
$('#form-add').submit(function(e) {
    ...
    $.ajax({
            ...
            url: '<?php echo base_url('Returns/prosesAdd'); ?>',
            type: "post",
        ...
        .done(function(data) {
            ...
            if (result.status == 'berhasil') {
                ...
                Swal.fire({
					...
					var link = '<?php echo base_url("return/") ?>';
