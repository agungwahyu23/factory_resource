							...
							<div class="row">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<input type="hidden" class="form-control" name="emp_id" value="<?= $request->emp_id ?>">
										<input type="text" class="form-control" name="" id="" autocomplete="off"
											placeholder="Enter Item Name" value="<?= $request->name_of_employee . ' - ' . $request->company ?>" readonly>
									</div>
								</div>
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="note" id="note" autocomplete="off"
											placeholder="Enter Notes" value="<?= $request->note ?>">
									</div>
								</div>
							</div>
