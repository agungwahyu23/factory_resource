                    ...
                    <form id="form-add" method="POST" enctype="multipart/form-data">
                        ...
                        <div class=" form-group">
                            ...
                            <input type="text" class="form-control" name="code_referral" id="code_referral"
                                autocomplete="off" placeholder="Enter Code Referral">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select name="is_active" id="is_active" class="form-control selek-status" required
...
$('#form-add').submit(function(e) {
    ...
    $.ajax({
            ...
            url: '<?php echo base_url('Promo/prosesAdd'); ?>',
            type: "post",
